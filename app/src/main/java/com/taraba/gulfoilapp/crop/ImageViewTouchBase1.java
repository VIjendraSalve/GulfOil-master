 ...
 */
abstract class ImageViewTouchBase1 extends ImageView {
    ...
    public ImageViewTouchBase1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ImageViewTouchBase1(Context context, AttributeSet attrs, int defStyle) {
