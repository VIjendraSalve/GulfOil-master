...
public class CropImageView1 extends ImageViewTouchBase {
    ...
    public CropImageView1(Context context) {
        super(context);
    }

    public CropImageView1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CropImageView1(Context context, AttributeSet attrs, int defStyle) {
