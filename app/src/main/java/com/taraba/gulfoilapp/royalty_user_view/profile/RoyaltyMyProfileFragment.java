 ...
 */
public class RoyaltyMyProfileFragment extends Fragment {
    ...
    private RoyaltyProfileDetailAdapter adapter;
    private String from = "";
    ...
    public static RoyaltyMyProfileFragment newInstance(String from, String mech_trno, String fullname, String shopname, String mobileNo, String distributorId, String Participant_code) {
        RoyaltyMyProfileFragment fragment = new RoyaltyMyProfileFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.activity_royalty_my_profile, container, false);
...
//        });
    ...
    public void initComp(View view) {
        ...
        adapter = new RoyaltyProfileDetailAdapter(getActivity(), keyValues);
