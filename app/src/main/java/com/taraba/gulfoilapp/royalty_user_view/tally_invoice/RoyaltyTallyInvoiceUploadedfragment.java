...
public class RoyaltyTallyInvoiceUploadedfragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.rootView = layoutInflater.inflate(R.layout.fragment_royalty_tally_invoice_uploaded, viewGroup, false);
        initView();
