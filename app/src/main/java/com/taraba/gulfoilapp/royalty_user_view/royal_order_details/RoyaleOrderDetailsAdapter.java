...
public class RoyaleOrderDetailsAdapter extends BaseAdapter {
    List<RewardOrderDetail> arrayList;
    Context context;
    private final String rewardCode;
    private final String rewardValue;

    public RoyaleOrderDetailsAdapter(Context context2, List<RewardOrderDetail> list, String str, String str2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.royalty_benefits_order_details_item, viewGroup, false);
        }
