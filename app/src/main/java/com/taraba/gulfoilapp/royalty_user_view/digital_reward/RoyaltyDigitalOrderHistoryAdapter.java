...
import com.taraba.gulfoilapp.royalty_user_view.digital_reward_detail.RoyaltyDigitalOrderDetailsFragment;
 ...
 */
public class RoyaltyDigitalOrderHistoryAdapter extends BaseAdapter {
    ...
    public RoyaltyDigitalOrderHistoryAdapter(Context context, List<DigitalOrderHistory> arrList, FragmentManager fm, boolean fromMechSearch) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.royalty_digital_order_history_list, parent,
                    false);
        }
        ...
        if (!TextUtils.isEmpty(arrayList.get(position).getOrdersIdPk()))
        ...
        convertView.findViewById(R.id.btn_view_codes).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment detailsFragment = new RoyaltyDigitalOrderDetailsFragment();
                Bundle b = new Bundle();
