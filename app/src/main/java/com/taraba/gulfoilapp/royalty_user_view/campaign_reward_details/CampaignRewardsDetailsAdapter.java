...
public class CampaignRewardsDetailsAdapter extends BaseAdapter {
    ...
    public CampaignRewardsDetailsAdapter(Context context2, List<RewardOrderDetail> list, String str, String str2) {
