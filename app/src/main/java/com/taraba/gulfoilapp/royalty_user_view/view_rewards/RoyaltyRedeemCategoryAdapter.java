 ...
 */
public class RoyaltyRedeemCategoryAdapter extends BaseAdapter {

    ArrayList<String> categories;
    Context context;
    LayoutInflater li;

    public RoyaltyRedeemCategoryAdapter(Context c, ArrayList<String> categories) {
        super();
        this.context = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = li.inflate(R.layout.royalty_spinner_category, null);
