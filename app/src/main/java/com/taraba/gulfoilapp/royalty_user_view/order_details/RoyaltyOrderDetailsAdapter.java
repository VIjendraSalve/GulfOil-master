 ...
 */
public class RoyaltyOrderDetailsAdapter extends BaseAdapter {

    Context context;
    ArrayList<OrderHistory> arrayList;

    public RoyaltyOrderDetailsAdapter(Context context, ArrayList<OrderHistory> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.royalty_order_details_item, parent,
                    false);
        }
