package com.taraba.gulfoilapp.royalty_user_view.help.about;
 ...
 * Modified by Mansi
 */
public class RoyaltyAboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        HTML = "<!DOCTYPE html><html><body style=\"text-align:justify;color: #ba8e57; background-color: #000;\">Please contact our  Toll free helpline number <a href='tel:18002094470'>18002094470</a> during 9:00AM to 6:00 PM(Monday - Saturday). Call Center will be closed on Public Holidays. </body></html>";
