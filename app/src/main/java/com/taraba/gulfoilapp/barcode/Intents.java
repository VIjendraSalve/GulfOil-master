...
public final class Intents {
    ...
    public static final class WifiConnect {
        /**
         * Internal intent used to trigger connection to a wi-fi network_security_config.
         */
        public static final String ACTION = "com.google.zxing.client.android.WIFI_CONNECT";

        /**
         * The network_security_config to connect to, all the configuration provided here.
         */
