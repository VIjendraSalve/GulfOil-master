package com.taraba.gulfoilapp.ui.help.faq;
...
public class NewFAQFragment extends Fragment {

    private Disposable disposable;
    private SharedPreferences userPref;
    private ProgressDialog progressDialog;
    private WebView wvHtmlView;
    private String strFAQ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_new_faq, container, false);
        init(view);
        callHelpAPI();
        return view;
    }
    ...
    private void helpResponse(HelpResponse response) {
        ...
        if (ServiceBuilder.isSuccess(response.getStatus())) {
            strFAQ = response.getData().getFaq();
            setDataToView();
        } else {
            new GulfUnnatiDialog(getActivity())
                    .setTitle(getString(R.string.str_error))
...
//        wvHtmlView.loadData(strFAQ, "text/html", "utf-8");
        webViewLoadData(wvHtmlView, strFAQ);
    }
