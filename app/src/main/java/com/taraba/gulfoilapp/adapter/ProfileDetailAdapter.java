...
public class ProfileDetailAdapter extends RecyclerView.Adapter<ProfileDetailAdapter.ProfileViewHolder> {
    ...
    public ProfileDetailAdapter(Context context, List<KeyValue> keyValues) {
    ...
    public ProfileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProfileViewHolder(LayoutInflater.from(context).inflate(R.layout.row_profile_details, parent, false));
    }
