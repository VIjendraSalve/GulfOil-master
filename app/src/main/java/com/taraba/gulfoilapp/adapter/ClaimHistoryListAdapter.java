 ...
 */
public class ClaimHistoryListAdapter extends ArrayAdapter<ClaimHistoryModel> {
    ...
    public ClaimHistoryListAdapter(Context context, List<ClaimHistoryModel> values) {
        super(context, R.layout.claim_history_list, values);
        this.values = values;
        this.context = context;
        this.darkOrange = context.getResources().getColor(R.color.org101);
        this.fentOrange = context.getResources().getColor(R.color.org100);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.claim_history_list, parent,
                    false);
        }
        ...
        LinearLayout llViewTransaction = (LinearLayout) convertView.findViewById(R.id.llViewTransaction);

        llViewTransaction.setBackgroundColor(flag ? darkOrange : fentOrange);
        flag = !flag;
...
//        final TextView basePoint = (TextView) convertView
//                .findViewById(R.id.basePoint);
//
//        final TextView bonusPoint = (TextView) convertView
//                .findViewById(R.id.bonusPoint);
//        final ImageView imageExpand=(ImageView) convertView.findViewById(R.id.imageExpand);
//        imageExpand.setImageResource(R.drawable.plus);

        // final LinearLayout llDetails=(LinearLayout)convertView.findViewById(R.id.llDetails);
//        TextView totalPoint = (TextView) convertView
//                .findViewById(R.id.totalPoint);
        try {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.point_details);
