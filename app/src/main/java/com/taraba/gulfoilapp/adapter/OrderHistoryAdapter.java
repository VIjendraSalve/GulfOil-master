...
import com.taraba.gulfoilapp.OrderDetailsFragment;
...
public class OrderHistoryAdapter extends BaseAdapter {
    ...
    public OrderHistoryAdapter(Context context, ArrayList<OrderHistory> arrList, FragmentManager fm, boolean fromMechSearch) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.order_history_list, parent,
                    false);
        }
        ...
        btn_orderDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment detailsFragment = new OrderDetailsFragment();
                Bundle b = new Bundle();
