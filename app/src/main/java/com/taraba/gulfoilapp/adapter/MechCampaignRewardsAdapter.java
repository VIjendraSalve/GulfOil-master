...
import com.taraba.gulfoilapp.MechCampaignRewardsDetailsFragment;
import com.taraba.gulfoilapp.R;
import com.taraba.gulfoilapp.model.CampaignRewards;

import java.util.List;

public class MechCampaignRewardsAdapter extends BaseAdapter {
    ...
    public MechCampaignRewardsAdapter(Context context2, List<CampaignRewards> list, FragmentManager fragmentManager2, boolean z) {
        this.arrayList = list;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.mech_campaign_rewards_history_list, viewGroup, false);
        }
        ...
        view.findViewById(R.id.btn_view_codes).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                bundle.putString("order_detail_id", MechCampaignRewardsAdapter.this.arrayList.get(i).getOrder_detail_id());
                mechCampaignRewardsDetailsFragment.setArguments(bundle);
                FragmentTransaction beginTransaction = ((FragmentActivity) MechCampaignRewardsAdapter.this.context).getSupportFragmentManager().beginTransaction();
                beginTransaction.replace(R.id.container_body, mechCampaignRewardsDetailsFragment);
