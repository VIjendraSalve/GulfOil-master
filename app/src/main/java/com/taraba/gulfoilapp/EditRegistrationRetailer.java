 ...
 * Modified by Mansi
 */
public class EditRegistrationRetailer extends Fragment implements View.OnClickListener {
    public static String date, gotolist;
    String selectedGender, selectedluckyDrawAnswer1, selectedluckyDrawAnswer2;
    RadioButton rBtn_male, rBtn_female, rBtn_answer1, rBtn_answer2, rBtn_answer3, rBtn_answer4,
            rBtn_answer, rBtn_answer11, rBtn_answer12, rBtn_answer13;
...
//                rBtn_answer2.setEnabled(false);
//                rBtn_answer3.setEnabled(false);
//                rBtn_answer4.setEnabled(false);
...
//                rBtn_answer11.setEnabled(false);
//                rBtn_answer12.setEnabled(false);
//                rBtn_answer13.setEnabled(false);
...
//                rBtn_answer13.setEnabled(false);
           ...
           /* if (MechanicalSearchFragment.circularList.get(position).getCommunication_consent().equals("yes")) {

                rBtn_communication.setChecked(true);
                rBtn_communication.setEnabled(false);
            }else {
                rBtn_communication.setEnabled(false);
            }
            ...
            if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_consent().equals("yes")) {
                ...
                rBtn_luckydrawconsent.setEnabled(false);
            }else {
                rBtn_luckydrawconsent.setEnabled(false);
            }*/
          ...
          /*  if(MechanicalSearchFragment.circularList.get(0).getLuckydraw_a1().equalsIgnoreCase("option1")){
            ...
            edt_m_shopname.setText("" + RetailerRegistrationFragment.retailerList.get(position).getWorkshop_name());
            edt_m_shopaddressline.setText("" + RetailerRegistrationFragment.retailerList.get(position).getWorkshop_address());


            edt_m_shopstreetaddress.setText("" + RetailerRegistrationFragment.retailerList.get(position).getWorkshop_address2());
            edt_m_shopLandmark.setText("" + RetailerRegistrationFragment.retailerList.get(position).getLandmark());
            edt_m_shopPincode.setText("" + RetailerRegistrationFragment.retailerList.get(position).getPincode());
            edt_m_shopSubdistrict.setText("" + RetailerRegistrationFragment.retailerList.get(position).getSub_district());
            edt_m_shopTownName.setText("" + RetailerRegistrationFragment.retailerList.get(position).getCity());
            edt_m_shopdistrict.setText("" + RetailerRegistrationFragment.retailerList.get(position).getDistrict());
            edt_m_shopState.setText("" + RetailerRegistrationFragment.retailerList.get(position).getState());
            edt_m_mobilenumber.setText("" + RetailerRegistrationFragment.retailerList.get(position).getMobile_no());
            edt_m_alternatemobilenumber.setText("" + RetailerRegistrationFragment.retailerList.get(position).getAlternate_mobile_no());
            edt_m_shopLandlinenumber.setText("" + RetailerRegistrationFragment.retailerList.get(position).getLandline_no());
            edt_m_email.setText("" + RetailerRegistrationFragment.retailerList.get(position).getEmail_id());
            edt_m_residentialAddressline1.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidential_address());
            edt_m_residentialAddressline2.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidential_address2());
            edt_m_residentialLandmark.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidential_landmark());
            edt_m_residentialPincode.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidential_pincode());
            edt_m_residentialCityName.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidential_city());
            edt_m_residentialAddressState.setText("" + RetailerRegistrationFragment.retailerList.get(position).getResidentialAddressState());
            edt_dateofbirth.setText("" + RetailerRegistrationFragment.retailerList.get(position).getDob());
            edt_dateofanniversary.setText("" + RetailerRegistrationFragment.retailerList.get(position).getAnniversary_date());
            edt_m_spouseName.setText("" + RetailerRegistrationFragment.retailerList.get(position).getSpouse_name());
            tv_retailerId1.setText("" + RetailerRegistrationFragment.retailerList.get(position).getRetailer_code());
            edt_m_distributorId.setText("" + RetailerRegistrationFragment.retailerList.get(position).getDb_code());
            edt_m_distributorName.setText("" + RetailerRegistrationFragment.retailerList.get(position).getDb_name());

            if (RetailerRegistrationFragment.retailerList.get(position).getParticipant_gender().equals("male")) {
                rBtn_male.setChecked(true);
            } else {
                rBtn_female.setChecked(true);
            }
            ...
            if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a1().equals("Multi G+")) {
                rBtn_answer1.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a1().equals("Multi G Max")) {
                rBtn_answer2.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a1().equals("Gulf MAX Supreme")) {
                rBtn_answer3.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a1().equals("Gulf Formula GX")) {
                rBtn_answer4.setChecked(true);
            } else {
                rBtn_answer1.setChecked(true);
            }
            ...
            if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a2().equals("Gulf Supreme Duty LE")) {
                rBtn_answer.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a2().equals("Gulf Cargo Power")) {
                rBtn_answer11.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a2().equals("Gulf Superfleet Turbo")) {
                rBtn_answer12.setChecked(true);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getLucky_draw_a2().equals(" Gulf Superfleet LE Dura Max")) {
                rBtn_answer13.setChecked(true);
            } else {
                rBtn_answer.setChecked(true);
            }
            ...
            if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("0")) {
                spn_children.setSelection(0);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("1")) {
                spn_children.setSelection(1);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("2")) {
                spn_children.setSelection(2);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("3")) {
                spn_children.setSelection(3);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("4")) {
                spn_children.setSelection(4);
            } else if (RetailerRegistrationFragment.retailerList.get(position).getNo_of_children().equals("5")) {
                spn_children.setSelection(5);
            }
   ...
   /* int selectId1 = myRadioGroupGender.getCheckedRadioButtonId();
    ...
    private void init(View view) {
        ...
        myRadioGroupLuckydrawanswer2 = (RadioGroup) view.findViewById(R.id.myRadioGroupLuckydrawanswer2);
          ...
          /* else if(edt_m_luckydrawquestion1.getText().toString().equals("")){
               ...
               edt_m_luckydrawQuestion2.requestFocus();
                ...
                if (NetworkUtils.isNetworkAvailable(getActivity())) {
                    ...
                    Log.e("Childrens", "children: " + strChildren);

//                    int id= myRadioGroupLuckydrawanswer1.getCheckedRadioButtonId();
//                    View radioButton = myRadioGroupLuckydrawanswer1.findViewById(id);
//                    int radioId = myRadioGroupLuckydrawanswer1.indexOfChild(radioButton);
//                    RadioButton btn = (RadioButton) myRadioGroupLuckydrawanswer1.getChildAt(radioId);
//                    String selection = (String) btn.getText();
//
//                    lucky_draw_a1=selection;
                    //Toast.makeText(getActivity(),""+lucky_draw_a1,Toast.LENGTH_LONG).show();
    ...
    */
    public void getData() {
        if (strtext.equals("list")) {
            ...
            SharedPreferences preferences2 = getActivity().getSharedPreferences("signupdetails", Context.MODE_PRIVATE);
            //  login_id_fk="1";
            login_id_fk = "" + preferences2.getString("usertrno", "");
            // login_id_fk=""+MechanicalSearchFragment.circularList.get(0).getId();
            category = "category";


            type = preferences2.getString("user_type", "");
       ...
       /* lucky_draw_a1="option1";
        lucky_draw_a2="option2";*/
            ...
            int id2 = myRadioGroupLuckydrawanswer2.getCheckedRadioButtonId();
            View radioButton2 = myRadioGroupLuckydrawanswer2.findViewById(id2);
            int radioId2 = myRadioGroupLuckydrawanswer2.indexOfChild(radioButton2);
            RadioButton btn2 = (RadioButton) myRadioGroupLuckydrawanswer2.getChildAt(radioId2);
            String selection2 = (String) btn2.getText();

            lucky_draw_a2 = selection2;


            // lucky_draw_a1 = "" + MechanicalSearchFragment.circularList.get(0).getLuckydraw_a1();
            // lucky_draw_a2 = "" + MechanicalSearchFragment.circularList.get(0).getLuckydraw_a2();
        }
                ...
                getActivity().runOnUiThread(new Runnable() {
                    public void run() {
                       /* Toast.makeText(getActivity(),
                        ...
                        Log.e("Network error ", "toast on update");
                    ...
                    cdd.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public void onDismiss(DialogInterface dialog) {
                            try {
                                ...
                                bundle.putInt("participant_login_id", Integer.parseInt(RetailerRegistrationFragment.retailerList.get(position).getLogin_id_fk()));
                                ...
                                bundle.putString("participant_code", "" + RetailerRegistrationFragment.retailerList.get(position).getRetailer_code());//jsonObject.getString("retailer_code"));
